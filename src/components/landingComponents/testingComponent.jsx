...
const TestingComponent = () => {
  ...
  const decode = () => {
    let _decodedPassword = customCrypto.decrypt(password)
    ...
    <div className="flex flex-col w-full h-full">
      <div className=" flex flex-col w-[40%]">
        <div className="flex flex-col w-full">
          <input type="text" className="" placeholder="Password to Encode" onChange={(e) => {
            setPassword(e.target.value);
          }}/>
          <input type="text" className="" placeholder="Password to Compare" onChange={(e) => {
            setComparePassword(e.target.value);
          }}/>
        </div>
        <div className="flex justify-between w-full">
          <button className="" onClick={encode}>Encode</button>
          <button className="" onClick={decode}>Decode</button>
          <button className="" onClick={compare}>Compare</button>
        </div>
