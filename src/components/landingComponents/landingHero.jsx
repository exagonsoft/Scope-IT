...
const LandingHero = () => {
  return (
    <section id="herosection">
      <div className="w-full flex sm:flex-row flex-col sm:gap-[5rem] gap-6 justify-center items-center">
        <div className="flex flex-col gap-1">
          <h1 className="head_text text-center sm:text-start overflow-x-visible flex-nowrap flex sm:absolute relative">
            Unlocking Efficiency...
          </h1>
          <span className=" head_text orange_gradient text-center sm:text-start sm:!mt-[6rem] sm:py-[1rem]">
            Saving Your Time
          </span>
