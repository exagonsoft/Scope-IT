...
const NavBar = () => {
  ...
  return (
    <nav className={`flex items-center flex-between w-full pt-2  ${session?.user ? 'pl-4' : 'pl-8'}  pr-8 m-2 mt-0 top-0 bg-transparent fixed z-10`}>
      <Link href={session?.user ? '/dashboard' : '/'} className="flex gap-2 flex-center flex-col">
